...
int main(int argc, char **argv)
{
  ...
  Mask2D<int> _pskelcc_stencil_1509_1564_mask;
  Stencil2D<Array2D<int>, Mask2D<int>, size_t> _pskelcc_stencil_1509_1564(inputGrid, outputGrid, _pskelcc_stencil_1509_1564_mask, 0);
  _pskelcc_stencil_1509_1564.runIterativeCPU(T_MAX, 0);
  return 0;
}
